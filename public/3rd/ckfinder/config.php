...
function CheckAuthentication() {
	...
	if (isset($_SESSION['ck']) && $_SESSION['ck'] == true) {
		return true;
	}
	return false;
}
 ...
 */
function getBaseUrl() {
	$baseUrl = $_SESSION['ck']['uploadDir'] . '/' . $_SERVER['SERVER_NAME'] . '/';

	if (isset($_SESSION['ck']['private']) && $_SESSION['ck']['private'] == true) {
		$baseUrl = $_SESSION['ck']['privateUserUploadDir'] . '/' . $_SESSION['ck']['user'] . '/';
	}

	/** Inventory file */

	if (isset($_SESSION['ck']['inventoryUpload']) && $_SESSION['ck']['inventoryUpload'] == true) {
		$baseUrl = $_SESSION['ck']['inventoryUploadDir'];
	}
	return $baseUrl;
}
...
ATTENTION: The trailing slash is required.
 */
$baseDir = resolveUrl($baseUrl, $webDir);
