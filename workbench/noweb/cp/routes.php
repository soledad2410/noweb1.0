...
Route::group(array('before' => 'domain'), function () {
	...
	Route::group(array('before' => 'admin'), function () {
		...
		Route::any('/cp/template/details/{name}', ['as' => 'cp-template-details', 'uses' => 'Noweb\\Cp\TemplateController@details']);
		Route::any('/cp/template/navigation', ['as' => 'cp-template-navigation', 'uses' => 'Noweb\\Cp\TemplateController@navigation']);
		Route::any('/cp/template/widgetconfig', ['as' => 'cp-template-widgetconfig', 'uses' => 'Noweb\\Cp\TemplateController@widgetConfig']);
	});
